...
class MiniShogiNNetBottleNeck:
    def __init__(self):
        ...
        h_conv1 = Activation('relu')(BatchNormalization(axis=3)(
            Conv2D(self.args.num_filters, self.args.kernel_size, padding='same', use_bias=False)(
        ...
        h_conv3 = Activation('relu')(BatchNormalization(axis=3)(
            Conv2D(self.args.num_filters, self.args.kernel_size, padding='valid', use_bias=False)(
